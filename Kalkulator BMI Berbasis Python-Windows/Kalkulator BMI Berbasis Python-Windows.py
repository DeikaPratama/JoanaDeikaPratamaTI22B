...
frame = Frame(ws,padx=10,pady=10,bg='#00FFFF')
...
tinggibadan_lb=Label(frame,text="Masukkan Tinggi Badan(cm) ")
tinggibadan_lb.grid(row=3,column=1)

beratbadan_lb=Label(frame,text="Masukkan Berat Badan(kg) ")
